...
namespace EccomerceAPI.Migrations
{
    ...
    [Migration("20220902203904_Adicionando relação de produtos com Centro de destribuição")]
    partial class AdicionandorelaçãodeprodutoscomCentrodedestribuição
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EccomerceAPI.Models.DistribuitonCenter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EccomerceAPI.Models.Product", b =>
                {
                    b.HasOne("EccomerceAPI.Models.DistribuitonCenter", "DistributionCenters")
                        .WithMany("Products")
