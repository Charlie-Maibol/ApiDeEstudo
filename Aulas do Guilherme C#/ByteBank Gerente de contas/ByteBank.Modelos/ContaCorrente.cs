...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        {
            // Retornar negativo quando a instancia precede o objeto;
            // Retornar zero quando a instancia e o objeto forem equivalentes;
            // Retornar número positivo diferente de zero quando a precedencia for do objeto;
